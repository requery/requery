...
class PreparedStatementAdapter extends StatementAdapter implements PreparedStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        throwIfClosed();
        try {
            String[] args = bindings.toArray(new String[bindings.size()]);
            if (cursor != null) {
    ...
    public int executeUpdate() throws SQLException {
        ...
        if (autoGeneratedKeys == RETURN_GENERATED_KEYS) {
            try {
                ...
                Cursor keyCursor = new SingleResultCursor(generatedColumnName, rowId);
                insertResult = new CursorResultSet(this, keyCursor, true);
            } catch (android.database.SQLException e) {
                DatabaseConnection.throwSQLException(e);
            }
            return 1;
