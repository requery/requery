...
public class DatabaseConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        ensureTransaction();
        return new PreparedStatementAdapter(this, sql, autoGeneratedKeys, null);
    }
    ...
    public PreparedStatement prepareStatement(String sql,
        ...
        ensureTransaction();
        return new PreparedStatementAdapter(this, sql, Statement.NO_GENERATED_KEYS, null);
    }
    ...
    public PreparedStatement prepareStatement(String sql, String[] columnNames)
        ...
        return new PreparedStatementAdapter(this, sql,
                Statement.RETURN_GENERATED_KEYS, columnNames[0]);
    }
