...
/**
 * {@link Result} type with RxJava 3.0 conversion methods.
 *
...
public class ReactiveResult<E> extends ResultDelegate<E> implements QueryWrapper, TransactionListenable {
    ...
    /**
     * Converts the result stream to a {@link io.reactivex.rxjava3.core.Flowable}. When the flowable terminates
    ...
    /**
     * Converts the result stream to a {@link io.reactivex.rxjava3.core.Maybe} value, return the first element
    ...
    /**
     * Converts the result stream to a {@link io.reactivex.rxjava3.core.Observable}. When the observable
    ...
    /**
     * Creates an {@link io.reactivex.rxjava3.core.Observable} that emits this result initially and then again
     ...
     *
     * @return {@link io.reactivex.rxjava3.core.Observable} instance of this result that is triggered whenever
