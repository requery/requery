 ...
 * @param <E> result type
 */
public class HavingConditionElement<E> extends BaseLogicalElement<HavingConditionElement<E>, HavingAndOr<E>>
    implements HavingAndOr<E>, QueryWrapper<E>, LogicalElement {

    private final QueryElement<E> query;

    HavingConditionElement(QueryElement<E> query,
                           Set<HavingConditionElement<E>> elements,
                           Condition<?, ?> condition,
    ...
    @Override
    HavingConditionElement<E> newElement(Set<HavingConditionElement<E>> elements, Condition<?,?> condition,
                                         LogicalOperator operator) {
        return new HavingConditionElement<>(query, elements, condition, operator);
    }
